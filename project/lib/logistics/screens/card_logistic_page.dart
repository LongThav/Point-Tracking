...
class CardLogisticProfile extends StatefulWidget {
  const CardLogisticProfile({super.key});

  @override
  State<CardLogisticProfile> createState() => _CardLogisticProfileState();
}

class _CardLogisticProfileState extends State<CardLogisticProfile> {
  @override
