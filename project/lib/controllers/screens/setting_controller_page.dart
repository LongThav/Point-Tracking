...
import '../../controllers/screens/profile_controller_page.dart';
import '../../mains/constants/colors.dart';
import '../../auths/services/user_local_service.dart';
import '../../mains/utils/route/route_name.dart';

class SettingControllerPage extends StatefulWidget {
  const SettingControllerPage({super.key});

  @override
  State<SettingControllerPage> createState() => _SettingControllerPageState();
}

class _SettingControllerPageState extends State<SettingControllerPage> {
  @override
            ...
            child: Center(
              child: Column(
                ...
                children: const [
                  Text(
                    'UserName',
                    style: TextStyle(color: AppColors.textColor, fontWeight: FontWeight.w500, fontSize: 24, fontFamily: 'Poppins_Bold_lite'),
                  ),
                  Text(
                    'example@email.com',
                    style: TextStyle(
      ...
      onTap: () {
        Navigator.of(context).push(PageRouteBuilder(
            ...
            pageBuilder: (context, animation, secondaryAnimation) {
              return const ProfileControllerPage();
            }));
      },
    );
  }
